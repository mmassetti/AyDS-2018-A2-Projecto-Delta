package ayds.dictionary.delta.fulllogic.modelo.database.room;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoConcept.equals(_existingConcept)) {
          throw new IllegalStateException("Migration didn't properly handle Concept(ayds.dictionary.delta.fulllogic.modelo.database.room.Concept).\n"
                  + " Expected:\n" + _infoConcept + "\n"
                  + " Found:\n" + _existingConcept);
        }
      }
